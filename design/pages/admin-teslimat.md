...
- **Engel şeridi** — yalnız kapatılması gerekenler, sertlik sırasıyla: rotaya hiç düşmemiş sipariş → hazır olmayanlar (**adıyla**) → kuryesiz → **kapısı başka posta kodunda görünen durak → kapı numarası doğrulanmamış durak** → takip numarası yazılmamış paket. Hiçbiri yoksa şerit sayı basmaz, tek cümle söyler: *"Araç çıkabilir."*
  - **Kapı doğrulaması yeni bir kalıp değil, şeridin iki yeni maddesidir** (11.11). Sayı basar, ad basmaz: *"2 durak başka posta kodunda görünüyor"* · *"1 durağın kapı numarası doğrulanmadı"*. Hangisi olduğunu kurye gün listesi söyler, telefonu operatör sipariş detayından açar (`admin-siparisler.md` §2). Cümle **"yanlış adres" demez**: müşteri kendi adresini bilerek korumuş olabilir ve çoğu zaman haklıdır
