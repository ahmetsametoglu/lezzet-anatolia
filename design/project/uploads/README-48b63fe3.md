...
## Sadelik ne demek — ne DEĞİL

Altın kuralımız "sade ve anlaşılır" **yanlış okunmaya çok açık.** Netleştirelim:

- **Sadelik = yoğunluğun içinde berraklık. Azlık DEĞİL.** İyi mimarlanmış yoğun bir ekran, üç kutulu boş bir ekrandan daha sadedir — çünkü kullanıcının aradığı her şey orada, düzenli. "Sade olsun" hiçbir zaman "az bilgi koy / güvenli oyna / minimal bırak" demek değildir.
- Karmaşıklığın **gizlenmesi** gerekir; **bilginin kısılması** değil. Sistemin iç terimleri (parti, rezervasyon, RFM) arayüze sızmaz — ama işletmecinin ihtiyacı olan bilgi zenginliği **tam** verilir.
- Bir ekranı "güvenli/minimal" bulduğunda dur: muhtemelen fakirdir, sade değil.

## Operasyon tezgâhı çıtası (yoğun ekranlar için)

Analitik, sipariş listesi, stok, müşteri, para, dashboard gibi ekranlar birer **çalışma tezgâhıdır** — işletmecinin her gün içinde yaşadığı araçlar, bir kez bakılıp geçilen özet kartları değil. Bu ekranlar tasarlanırken dört boyut **beklenir**:

1. **Hırs / çıta:** Hedef, **referans-sınıf bir çalışma aracı.** Bu ekranı ciddi bir analitik/operasyon ürününün en iyileriyle yarışacak yoğunluk ve olgunlukta düşün. "İşi görür, standart, temiz" yeterli değil — "bunu her gün açmak isterim" hedefi.
2. **Kullanım ömrü / etkileşim derinliği:** Ekran, aylarca **her gün açılan** biri için tasarlanır. Bu, tek-seferlik bakıştan çok farklı şeyler ister: **kıyas omurgası** (neredeyse her sayı "önceki döneme göre" bir değişimle gelir), süzme, derine inme (bir rakamdan detayına), aralık/olay işaretleme ("burada kampanya yaptık"), sütun sıralama, blok başına küçük "bu nedir?" yardımı. Statik rakam değil, **gezilebilir** bir yüzey.
3. **Gerçek + boş veriye karşı tasarım:** Uydurma sağlıklı rakamlarla ("3.418 ziyaretçi") tasarlamak yasak — o bir maket üretir, gerçek veriyle buluşunca çöker. Sistem **ilk günü** de dahil tasarlanır: "henüz satış yok", "1 ziyaret", "0 €" halleri **birinci sınıf** kurgulanır. Boş durumu güzel çözmek, yapıyı kendiliğinden zenginleştirir.
4. **İşletmecinin tam soru haritası:** Ekran, kullanıcının o konudaki **bütün tekrar eden sorularına** cevap verir ve mimarlanır — ince bir dilim değil. İş modelimizin eksenleri her yerde birinci sınıftır: **B2B/B2C ayrımı**, **ciro/gelir**, **trafik ↔ ticaret** ayrımı, zaman/coğrafya/kaynak kırılımları. "Neyi göstereyim" değil, "bu kişinin bu ekrandan çıkarken cevaplamış olması gereken sorular neler" diye kurulur.

Bu çıta, "sunum kararı Claude Design'ındır" ilkesini bozmaz: renk/yerleşim yine tasarımcınındır. Değişen tek şey, tasarımcıya **düşük değil yüksek bir hırs** ve **nasıl yaşandığı** bilgisinin verilmesidir.
