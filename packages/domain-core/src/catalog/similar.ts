 ...
 *
 * Terfi 21.6 (D): kaynağı `apps/web/lib/storefront/similar.ts`ti, artık sahibi bu paket. Kural bir
 * DOMAIN kararıdır — hangi kartın gösterileceği, veriyi nereden okuduğumuzla ilgisiz — ve iki yüzey
 * birden (web vitrini, mobil katalog) aynı seçkiyi göstermek zorunda: ayrı yazılsalar aynı ürünün
 * altında iki farklı "benzer" listesi doğardı. Web kopyası geçiş köprüsüdür.
 *
