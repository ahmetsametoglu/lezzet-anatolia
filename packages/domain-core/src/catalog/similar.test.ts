 ...
 *
 * Terfi 21.6 ile dosya domain-core'a taşındı; artık **birim** projesinde koşuyor (DB'siz, paralel)
 * — web'de entegrasyon kökündeydi ve seri bekliyordu, oysa tek bir sorgu bile atmıyor.
 */
