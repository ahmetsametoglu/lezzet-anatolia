...
import { forgetAccountLocale } from '../i18n/app-locale';
...
/**
 * Oturum kapanınca düşmesi gereken UYGULAMAYA ÖZGÜ cihaz durumu için kayıt (21.310). Dönen fonksiyon
 * kaydı bırakır. Temizlik eşzamanlıdır ve fırlatmamalıdır: kapanış asla yarım kalmaz.
 */
 ...
 *
 * UYGULAMANIN KENDİ CİHAZ DURUMU DA DÜŞER (21.310): seçili teslimat adresi (27.08) gibi yalnız bir
 * uygulamanın bildiği durum burada ADIYLA çağrılmaz, çünkü bu kapı ortak çekirdekte ve kit
 * uygulamaya bağlanamaz. Durumu tutan modül kendini `registerSessionCleanup` ile kaydeder; kapanışta
 * kayıtlı her temizlik koşar. 27.08'in gerekçesi aynen geçerli: kalan kimlik yeni müşteride hiçbir
 * şeye karşılık gelmez ve ekran o arada başkasının adresini seçili gösterirdi.
 */
