...
/* Ekran iniş yerini ve evi uygulamadan alır (21.310) — müşteri uygulamasının kararının şekli:
   personel operasyona, müşteri hesaba. Kuralın kendisi `post-login-route.test.ts`te. */
const ROUTES = {
  landingFor: (me: Me) => (me.roles.some((role) => role !== 'customer') ? ('/warehouse' as const) : null),
