...
const COPY: Record<PreferredLanguage, Copy> = {
  tr: {
    ...
    refundNote: 'Ödeme yaptığınız yönteme iade edilir; hesabınıza geçiş süresi bankanıza bağlıdır.',
  ...
  de: {
    ...
    blockDetail: 'Die Bestellung wurde noch nicht vorbereitet; es wurde nichts verschickt. Sie müssen nichts weiter tun.',
    refundTitle: 'Erstattung',
    orderAmount: 'Bestellbetrag',
    refunded: 'Erstattet',
    refundNote: 'Erstattung auf das genutzte Zahlungsmittel; wann sie gutgeschrieben wird, hängt von Ihrer Bank ab.',
    ...
    helpTitle: 'Haben Sie diese Stornierung nicht erwartet?',
