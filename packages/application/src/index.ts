...
// Kurye dönüşü (D6 · v3:14): depocunun kabul kapısı — çağıranı `/api/v1/warehouse` (depo şeridi bağlar).
...
export { countAwaitingHandover, handOverBox, type HandoverOutcome } from './shipping/handover';
