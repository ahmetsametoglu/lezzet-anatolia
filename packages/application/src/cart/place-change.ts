 ...
 *
 * **TERFİ (aşama 1/3)** — kaynağı `apps/web/lib/cart/place-change.ts`tı; web kopyası KÖPRÜ.
 * Mobil yer seçicisi de aynı farkı gösterecek: iki yüzey aynı sepette farklı "kargoya düştü"
 * diyemez.
 */
