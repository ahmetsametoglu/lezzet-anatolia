...
/*
  ...
  Paket BİLEREK yalın: tek bağımlılığı React ve o da `peerDependency`. Ne RN'yi bilir ne Next'i;
  bildiği tek şey `useEffect/useState/useRef`. `@lezzet/address-fr`in "iki yüzeye birden bakar"
  kararının (09.08) aynısı, bu kez davranış katmanında.
  ...
  3. YARIŞ — geç dönen cevap yeni sorgunun önerilerini EZMEZ (`generation` sayacı; native deposunun
