...
- [ ] (18.5) **Log ve alarm:** JSON log + logrotate; kritik hatada (webhook düşmesi, cron gecikmesi, ödeme hatası) admin'e e-posta. *Öneri:* ağır APM değil, ölçeğe uygun asgari; büyüyünce Sentry.
