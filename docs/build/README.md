...
| 08 | `08-musteri-app.md` | Müşteri Web Uygulaması (Vitrin) | sürüyor | 22/31 (+9 kısmi) |
...
| 19 | `19-coklu-depo.md` | Çok Depo (Depo Ağı) | sürüyor | 16/23 (+6 kısmi) |
| 20 | `20-yapay-zeka.md` | Yapay Zekâ | sürüyor | 2/4 |
| 21 | `21-mobil-uygulama.md` | Mobil Uygulama | sürüyor | 11/19 (+6 kısmi) |
| 22 | `22-mcp-asistan.md` | MCP Yönetici Asistanı | sürüyor | 2/4 (+1 kısmi) |
<!-- durum:son -->
