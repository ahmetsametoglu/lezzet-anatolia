...
| 15 | `15-whatsapp.md` | WhatsApp: Zemin ve Canlı Kanal | sürüyor | 3/16 (+2 kısmi) |
...
| 19 | `19-coklu-depo.md` | Çok Depo (Depo Ağı) | sürüyor | 25/31 (+5 kısmi) |
| 20 | `20-yapay-zeka.md` | Yapay Zekâ | sürüyor | 3/4 |
| 21 | `21-mobil-uygulama.md` | Mobil Uygulama | sürüyor | 77/93 (+12 kısmi) |
