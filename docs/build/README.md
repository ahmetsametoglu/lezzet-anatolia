...
| 05 | `05-katalog.md` | Katalog: Servisler ve Yönetim Zemini | sürüyor | 7/12 (+1 kısmi) |
...
| 08 | `08-musteri-app.md` | Müşteri Web Uygulaması (Vitrin) | sürüyor | 0/11 (+3 kısmi) |
...
| 12 | `12-para-muhasebe.md` | Para, Ön Muhasebe ve Kârlılık | sürüyor | 2/7 |
