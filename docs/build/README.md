...
| 10 | `10-depo.md` | Depo Yüzeyi | sürüyor | 7/9 (+2 kısmi) |
...
| 15 | `15-whatsapp.md` | WhatsApp: Zemin ve Canlı Kanal | sürüyor | 8/19 (+7 kısmi) |
...
| 21 | `21-mobil-uygulama.md` | Mobil Uygulama | sürüyor | 98/115 (+13 kısmi) |
| 22 | `22-mcp-asistan.md` | MCP Yönetici Asistanı | sürüyor | 22/39 (+11 kısmi) |
