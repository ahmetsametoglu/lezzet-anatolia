...
| 01 | `01-types.md` | `packages/types`: Şemalar ve Enum'lar | tamam | 12/12 |
...
| 14 | `14-bildirim-email.md` | Bildirim ve E-posta: `packages/email` + `packages/notify` | sürüyor | 10/16 (+1 kısmi) |
...
| 21 | `21-mobil-uygulama.md` | Mobil Uygulama | sürüyor | 104/120 (+13 kısmi) |
| 22 | `22-mcp-asistan.md` | MCP Yönetici Asistanı | sürüyor | 26/40 (+12 kısmi) |
