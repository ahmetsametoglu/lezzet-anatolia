...
| 02 | `02-database.md` | `packages/database`: Taban Servis ve İlk Şema | sürüyor | 10/12 (+1 kısmi) |
...
| 08 | `08-musteri-app.md` | Müşteri Web Uygulaması (Vitrin) | sürüyor | 10/19 (+8 kısmi) |
