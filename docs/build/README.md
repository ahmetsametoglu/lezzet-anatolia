...
| 08 | `08-musteri-app.md` | Müşteri Web Uygulaması (Vitrin) | sürüyor | 47/53 (+4 kısmi) |
...
| 15 | `15-whatsapp.md` | WhatsApp: Zemin ve Canlı Kanal | sürüyor | 5/18 (+8 kısmi) |
...
| 21 | `21-mobil-uygulama.md` | Mobil Uygulama | sürüyor | 85/102 (+13 kısmi) |
| 22 | `22-mcp-asistan.md` | MCP Yönetici Asistanı | sürüyor | 21/39 (+11 kısmi) |
| 23 | `23-barkod-kutu.md` | Barkod/QR ile Operasyon Takibi | sürüyor | 8/13 (+2 kısmi) |
<!-- durum:son -->
