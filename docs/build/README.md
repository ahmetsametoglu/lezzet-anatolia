...
| 05 | `05-katalog.md` | Katalog: Servisler ve Yönetim Zemini | sürüyor | 11/14 (+2 kısmi) |
...
| 08 | `08-musteri-app.md` | Müşteri Web Uygulaması (Vitrin) | sürüyor | 11/20 (+8 kısmi) |
...
| 13 | `13-analitik.md` | Analitik | sürüyor | 1/8 (+7 kısmi) |
| 14 | `14-bildirim-email.md` | Bildirim ve E-posta: `packages/email` + `packages/notify` | sürüyor | 6/10 |
