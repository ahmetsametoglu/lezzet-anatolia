...
| 08 | `08-musteri-app.md` | Müşteri Web Uygulaması (Vitrin) | sürüyor | 52/57 (+4 kısmi) |
...
| 21 | `21-mobil-uygulama.md` | Mobil Uygulama | sürüyor | 92/109 (+13 kısmi) |
| 22 | `22-mcp-asistan.md` | MCP Yönetici Asistanı | sürüyor | 21/39 (+11 kısmi) |
| 23 | `23-barkod-kutu.md` | Barkod/QR ile Operasyon Takibi | sürüyor | 13/14 |
<!-- durum:son -->
