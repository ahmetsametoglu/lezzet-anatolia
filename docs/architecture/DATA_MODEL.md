...
- **Posta kodu tekilliği veridedir (01.08):** kod → tek aktif bölge → tek depo; bağ tablosunda `postal_code` birincil anahtardır. Bugünkü "ilki kazanır" sessiz çözümü çok depoda siparişi yanlış depoya düşürürdü; çakışma kayıt anında reddedilir, motor belirsizlikte hata döner.
