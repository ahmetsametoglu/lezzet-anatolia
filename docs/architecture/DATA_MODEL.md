...
- `stock_write_off_reason`: expired, damaged, lost, transfer_shortfall
  - `transfer_shortfall` (04.09, `21.248`): transfer eksiği — alan deponun beyanı; hareket `transfer_id` taşır, sebep listesinde transit kaybı sayım kaybından ayrı süzülür.
