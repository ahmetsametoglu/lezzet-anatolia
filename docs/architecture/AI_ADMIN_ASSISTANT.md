...
| --- | --- | --- |
| **A — salt okuma** | kuyruk yok, maskeli özetler | sistem sağlığı + hata raporu (`error_log`/`job_run`/health) · satış-finans özetleri (§6 taneliğinde) · katalog/stok durumu (eksik beyan, düşük stok, vitrin doluluğu) · tedarik önerisi okuması · analitik özetler (huni, talep panosu) · **yazışma-gözlem özeti** (konuşma hacmi/aşama/eskalasyon/memnuniyet sinyali — kimliksiz ve içeriksiz, §1 "Ne DEĞİL"; yönetim değil gözlem) |
