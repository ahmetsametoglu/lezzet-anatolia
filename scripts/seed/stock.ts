...
export async function seedStock(db: Db, varyantlar: VaryantRef[], tedarik: Map<string, string>): Promise<void> {
...
export async function seedTemperatureLogs(db: Db, kisiler: Kisiler): Promise<void> {
