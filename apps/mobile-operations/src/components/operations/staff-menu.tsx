...
/*
  ...
  *"operasyon yüzeyinde hiç çıkış yolu yoktu… dükkândaki tablette biri açık oturumu kapatmak
  ...
  ── MENÜ İKİ İŞ TAŞIR (kullanıcı kararı 22.08) ───────────────────────────────
  ...
  2. OTURUMU KAPAT — bugün hiç olmayan kapı.
  Üçüncü iş "müşteri uygulamasına geç" köprüsüydü; müşteri ve operasyon ayrı uygulama olunca
  (21.310) kalktı — personel müşteri uygulamasını kendi ikonundan açar.
        ...
        <View style={styles.actions}>
          ...
          */}
          ...
          {/* Çıkış terracotta: kitin "dikkat isteyen eylem" tonu, hesap ekranındaki çıkışla aynı.
              ...
              hâlükârda temizliyor, oturum düşünce kapı bunu KENDİ duyuyor ve giriş ekranına
              yönlendiriyor (`use-operations-access` künyesi).
