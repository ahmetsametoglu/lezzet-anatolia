...
/*
  ...
  Dosya `src/app/` İÇİNE konamaz: expo-router o klasördeki her `.tsx`i ROTA sayar (müşteri
  uygulamasının kabuk testindeki künye).
...
// Cihaz dili sabitlenir: giriş ekranının (ortak çekirdek, çok dilli) metni makinenin diline
...
describe('operasyon kabuğu — kapı', () => {
  it('yalnız müşteri rolü operasyona GİREMEZ: "yetki yok" der ve çıkış sunar', async () => {
  ...
  it('rol OKUNAMAZSA "yetkin yok" DENMEZ: hata bloğu çıkar ve tekrar denenince kabuk açılır', async () => {
    ...
    // "Yetki yok" DENMEDİ — yetki hakkında bir iddiada bulunulmadı.
    expect(screen.queryByTestId('operations-gate-forbidden')).toBeNull();
