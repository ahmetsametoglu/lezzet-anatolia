...
/*
  ...
  SADELEŞTİRİR. Tam o yüzden test ediliyor: `error` dalını `forbidden`a katan bir "sadeleştirme"
...
describe('operasyon kapısı', () => {
  ...
  */
  ...
  it('OTURUM YOKSA (401) giriş istenir — bu KESİN bir cevaptır, arıza değil', async () => {
  ...
  it('YALNIZ MÜŞTERİ ise YETKİ YOK — cevap geldi, bölüm yok; oturumsuzluktan ayrı hâl', async () => {
  ...
  it.each([
    ...
    // Kırılgan olan tam bu ayrım: `error`ı `forbidden`a katmak kodu sadeleştirir ve şebekesiz kuryeye
    // sessizce "yetkin yok" der. Hâllerin birleşmesi burada kırmızı yanar.
