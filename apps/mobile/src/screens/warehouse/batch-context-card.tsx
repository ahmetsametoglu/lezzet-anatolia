...
/*
  PARTİNİN YERİ BU KARTTA DEĞİL (kullanıcı kararı 03.09, ikinci tur): bir ara rozet + "değiştir →"
  olarak buradaydı; kullanıcı beğenmedi (*"çok hoş yapmamışım"*) ve adet girdisiyle aynı boyda kendi
  bölümüne taşındı (`batch-area-field`). Kart KİMLİKTİR (ad · numara · tarih · iki sayı), yer ise
  bir GİRDİ — girdiler gövdede durur.
*/
