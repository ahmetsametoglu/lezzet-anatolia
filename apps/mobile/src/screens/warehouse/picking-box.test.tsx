...
describe('D1 · kutu döngüsü', () => {
  ...
  it('okutulan koli ÇARPAN kadar ekler ama tavan motorun kapasitesidir; yabancı ürün kutuya girmez', async () => {
    ...
    net.resolve = {
      ...
      variantLabel: line.variantLabel, kind: 'case', qtyPerCode: 6, source: 'barcode', sku: 'SKU-4120', dateType: 'DDM', shelfLifeDays: 360, imageUrl: null,
    };
    await renderPicking();
    ...
    net.resolve = {
      ...
      variantLabel: '250 g', kind: 'unit', qtyPerCode: 1, source: 'barcode', sku: 'SKU-4120', dateType: 'DDM', shelfLifeDays: 360, imageUrl: null,
    };
