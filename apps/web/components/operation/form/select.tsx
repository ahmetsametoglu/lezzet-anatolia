  ...
  return (
    <div ref={anchorRef} className={className}>
      <button
        ...
        aria-expanded={open}
        className={[
          'flex w-full cursor-pointer items-center justify-between gap-3 rounded-ops-card border bg-ops-white px-[13px] py-[7px] font-ops-body text-[13.5px] font-medium outline-none transition-colors',
