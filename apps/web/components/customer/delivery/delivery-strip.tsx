 ...
 *
 * Üç yerde aynı şerit: adres penceresinin doğrulama kutusu, yer penceresinin sonuç satırı
 * (`PlaceLookupResults`) ve sepetin adres kartı (14.09). İki kopya bir gün iki ayrı dil konuşurdu.
 */
...
export function DeliveryStrip({ inRoute, tone = 'cream', children }: DeliveryStripProps) {
  return (
    <div
      className={[
        'flex items-start gap-2 rounded-xl px-3 py-2.25 font-sans text-note leading-normal font-semibold text-body',
