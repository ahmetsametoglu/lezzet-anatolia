  ...
  return (
    <div className="flex flex-1 flex-col gap-4 overflow-y-auto p-8">
      <div className="flex flex-col gap-1">
        <h1 className="font-ops-display text-ops-title font-semibold text-ops-ink">Panel</h1>
        <p className="font-ops-body text-ops-base text-ops-muted">
          Operasyonun günlük özeti — sipariş, rota ve para göstergeleri sonraki dilimde.
        </p>
      </div>
      <Card className="p-8">
        <p className="font-ops-body text-ops-base text-ops-body">
