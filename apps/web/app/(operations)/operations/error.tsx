  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3.5 border-b border-ops-line px-6 py-4">
        <span className="font-ops-display text-ops-section font-semibold text-ops-ink">Beklenmeyen hata</span>
        <span className="flex items-center gap-1.5 rounded-md bg-ops-red-bg px-2.5 py-1 font-ops-display text-ops-micro font-semibold text-ops-red">
      ...
      >
        ...
        <div className="mt-0.5 flex items-center gap-2 rounded-lg border border-ops-line bg-ops-subtle py-2 pl-3.5 pr-2">
          <div className="flex flex-col items-start gap-px">
            <span className="font-ops-display text-ops-micro font-medium uppercase tracking-[0.06em] text-ops-muted">Referans</span>
            <span className="font-ops-mono text-ops-base text-ops-ink">{refCode}</span>
          </div>
        ...
        <div className="w-full max-w-[520px] overflow-hidden rounded-lg border border-ops-line bg-ops-subtle text-left">
          ...
          {stack && (
            <details className="group border-t border-ops-line">
              <summary className="flex cursor-pointer list-none items-center gap-1.5 px-3.5 py-2 font-ops-display text-ops-xs font-medium text-ops-muted outline-none transition-colors hover:text-ops-body focus-visible:text-ops-body [&::-webkit-details-marker]:hidden">
                <span className="transition-transform group-open:rotate-180">
                  <ChevronDownIcon />
                </span>
                Yığın izi
              </summary>
              <pre className="max-h-40 overflow-auto whitespace-pre-wrap break-words border-t border-ops-line px-3.5 py-2.5 font-ops-mono text-ops-xs leading-relaxed text-ops-muted">
                {stack}
              </pre>
            </details>
          )}
        ...
        <div className="max-w-[520px] rounded-ops-card border border-ops-red-line bg-ops-red-bg px-3.5 py-2.5 text-left font-ops-body text-ops-sm leading-relaxed text-ops-red-dark">
